<%-- 
    Document   : catalogo
    Created on : 8/12/2024, 3:55:26 p. m.
    Author     : User
--%>
        ...
        <div class="menu container">
            ...
            <nav class="navbar">
                ...
                <div class="imagen-usuario">
                  <a href="/Crud1/pagina/factura"><img src="../Img/avatar.png" alt="Dashboard"> </a> 
                </div>
            </nav>
        </div>
                    ...
                    <div class="swiper-slide">
                        <div class="slide">
                            <div class="slide-txt">
                                <h1> Luffy </h1>
                                <p>
                                    ¡Lleva contigo a tu personaje favorito de One Piece! Este adorable llavero o decoración está confeccionado 
                                    con lana de alta calidad y es perfecto para cualquier fanático del anime. Regálalo a alguien especial 
                                    o consíguelo para ti mismo, ¡será un detalle que hará sonreír a cualquier amante de One Piece!
                                </p>

                                <div class="botones">
                                <a href="/Crud1/pagina/carrito" class="btn-1">Comprar</a>
                                </div>
                    ...
                    <div class="swiper-slide">
                        <div class="slide">
                            <div class="slide-txt">
                                <h1> Kirby </h1>
                                <p>
                                    ¡La estrella de Kirby ha aterrizado en Michigurumis! Este tierno Kirby sentado en su estrella es el compañero 
                                    perfecto para cualquier fanático del videojuego. Confeccionado con lana de alta calidad y detalles precisos, 
                                    este Kirby es una de arte que te hará sonreír. Regálalo a un amigo o personita especial, o también, consíguelo para ti mismo, 
                                    ¡será un detalle que brillará en tu colección!
                                  </p>
                        ...
                        <div class="swiper-slide">
                            <div class="product">
                                ...
                                <div class="product-txt">
                                    ...
                                    <div class="btn-3">
                                    <a href="/Crud1/pagina/carrito">Comprar</a>
                                    </div>
                        ...
                        <div class="swiper-slide">
                            <div class="product">
                                <div class="product-img">
                                    ...
                                    <img src="../Img/Chimuelo blanco.png"alt="">
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="product">
                                <div class="product-img">
                                    ...
                                    <img src="../Img/Dinosaurio.PNG" alt="">
                                </div>
