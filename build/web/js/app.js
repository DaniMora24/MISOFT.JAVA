...
function guardarCarritoEnLocalStorage() {
    var carritoItems = document.getElementsByClassName('carrito-items')[0].getElementsByClassName('carrito-item');
    var carritoArray = [];
    ...
    for (var i = 0; i < carritoItems.length; i++) {
        ...
        carritoArray.push({ titulo, precio, imagenSrc, cantidad });
    }

    localStorage.setItem('productosCarrito', JSON.stringify(carritoArray));
}

// Cargar el carrito desde localStorage
function cargarCarritoDesdeLocalStorage() {
    var carritoArray = JSON.parse(localStorage.getItem('productosCarrito')) || [];
    var itemsCarrito = document.getElementsByClassName('carrito-items')[0];
    ...
    carritoArray.forEach(producto => {
        ...
        // Agregar eventos a los botones de los items cargados
        item.getElementsByClassName('btn-eliminar')[0].addEventListener('click', eliminarItemCarrito);
