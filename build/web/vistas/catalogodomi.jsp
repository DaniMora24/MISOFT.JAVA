<%-- 
    Document   : catalogodomi
    Created on : 8/12/2024, 3:55:19 p. m.
    Author     : User
--%>
        ...
        <div class="menu container">
            ...
            <nav class="navbar">
                ...
                <div class="imagen-usuario">
                 <a href="${pageContext.request.contextPath}/usuarios/envios?action=list"><img src="../Img/avatar.png" alt="Dashboard"> </a> 
                </div>
            </nav>
        </div>
